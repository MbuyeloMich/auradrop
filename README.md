...
auradrop is a smart price tracker web app that monitors products across online stores and sends instant alerts when prices drop.
...
graph TB
    ...
    style D fill:#3ECF8E,stroke:#fff,stroke-width:2px
    style E fill:#316192,stroke:#fff,stroke-width:2px
    style H fill:#FF6B35,stroke:#fff,stroke-width:2px
    style I fill:#000000,stroke:#fff,stroke-width:2px
```

<div align="center">
  <img src="https://skillicons.dev/icons?i=nextjs,react,supabase,postgresql,tailwind,vercel" alt="Tech Stack Icons"/>
</div>
...
<br><sub>React framework with App Router</sub>
</td>
<td align="center" width="33%">
<img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/react/react-original.svg" width="60" height="60" alt="React"/>
<br><strong>React 18</strong>
<br><sub>UI library with hooks</sub>
</td>
<td align="center" width="33%">
<img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/supabase/supabase-original.svg" width="60" height="60" alt="Supabase"/>
<br><strong>Supabase</strong>
<br><sub>Backend platform</sub>
</td>
</tr>
<tr>
<td align="center" width="33%">
...
<br><sub>Database with pg_cron</sub>
</td>
<td align="center" width="33%">
...
- 🔥 **Firecrawl** - Web data extraction with AI-powered scraping
...
```bash
git clone https://github.com/MbuyeloMich/auradrop.git
cd auradrop
npm install
```
